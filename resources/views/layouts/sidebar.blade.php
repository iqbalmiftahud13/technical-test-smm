        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('department.index') }}" class="waves-effect">
                ...
                <li>
                    <a href="{{ route('permintaan.index') }}" class="waves-effect">
                ...
                {{-- <li class="menu-title" key="t-backend">Data Master</li>
                <li>
                    <a href="{{ route('department.index') }}" class="waves-effect">
                        <i class="bx bx-list-ul"></i>
                        <span key="t-yajra-datatable">Departement</span>
                    </a>
                </li>
                <li>
                    <a href="yajra-datatable" class="waves-effect">
                        <i class="bx bx bx-box"></i>
                        <span key="t-yajra-datatable">Barang</span>
                    </a>
                </li> --}}
