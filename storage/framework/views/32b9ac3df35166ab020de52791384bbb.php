    ...
    <script type="text/javascript">
        $(function() {
            ...
            function renderAction(data, type, row, meta) {
                let url = "<?php echo e(route('permintaan.destroy', ':id')); ?>"
                let urlDetail = "<?php echo e(route('permintaan.show', ':id')); ?>"
        ...
        var vue = new Vue({
            ...
            data() {
                return {
                    departments: <?php echo json_encode($department, 15, 512) ?>,
                    barang: <?php echo json_encode($barang, 15, 512) ?>,
            ...
            methods: {
                ...
                handleCreateData() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('permintaan.store')); ?>",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\TechnicalTest-SMM\resources\views/admin/pages/permintaan/index.blade.php ENDPATH**/ ?>